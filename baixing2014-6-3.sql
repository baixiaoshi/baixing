...
CREATE TABLE `dr_1_news` (
  ...
  `jiage` decimal(10,0) DEFAULT '0' COMMENT '价格',
  `zhaopian` text COMMENT '照片',
  `sex` varchar(255) DEFAULT NULL COMMENT '性别',
  `xiaoyuanshehui` varchar(255) DEFAULT NULL COMMENT '校园/社会',
  `gongsigeren` varchar(255) DEFAULT NULL COMMENT '公司/个人',
  `bibeitiaojian` text COMMENT '必备条件',
  ...
  `myunit` varchar(20) DEFAULT NULL COMMENT '价格单位',
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`),
...
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='主表';

/*Data for the table `dr_1_news` */

insert  into `dr_1_news`(`id`,`catid`,`title`,`thumb`,`description`,`hits`,`uid`,`author`,`status`,`url`,`tableid`,`inputip`,`inputtime`,`updatetime`,`displayorder`,`jiage`,`zhaopian`,`sex`,`xiaoyuanshehui`,`gongsigeren`,`bibeitiaojian`,`provinces`,`provalue`,`city`,`cityvalue`,`area`,`areavalue`,`myunit`) values (1,9,'asdfsa','','',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 9, 9, 1401686998)',0,NULL,0,0,0,'20','','男','校园','公司','',0,'',0,'',0,'0',NULL),(2,9,'找家教','','我有很多空闲时间，想找一个家教',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 9, 9, 1401687168)',0,NULL,0,0,0,'40','a:3:{s:4:\\\"file\\\";a:1:{i:0;s:1:\\\"3\\\";}s:3:\\\"pan\\\";a:1:{i:0;s:0:\\\"\\\";}s:5:\\\"title\\\";a:1:{i:0;s:6:\\\"pic001\\\";}}','男','校园','公司','基础不能太差',0,'',0,'',0,'0',NULL),(3,9,'代购','','你是我的东西',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 9, 9, 1401687275)',0,NULL,0,0,0,'20','','女','校园','个人','',0,'',0,'',0,'0',NULL),(4,9,'hello world','','',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 9, 9, 1401698681)',0,NULL,0,0,0,'20','','男','校园','公司','',0,'',0,'',0,'0',NULL),(5,9,'HELLOWW','','DFSFASD',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 9, 9, 1401698894)',0,NULL,0,0,0,'20','','男','校园','公司','',0,'',0,'',0,'0',NULL),(6,9,'sdfas','','sdfas',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 9, 9, 1401699815)',0,NULL,0,0,0,'10','','男','校园','公司','',0,'',0,'',0,'0',NULL),(7,12,'dsafafa','','asdfasf',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 12, 9, 1401699970)',0,NULL,0,0,0,'20','','男','校园','公司','',0,'',0,'',0,'0',NULL),(8,9,'我的标题','','我要找一个份兼职工作',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 9, 9, 1401700023)',0,NULL,0,0,0,'20','','男','校园','公司','',0,'',0,'',0,'0',NULL),(9,32,'dsafadsfa','','asdfasdf',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 32, 9, 1401704085)',0,NULL,0,0,0,'10','','男','校园','公司','',6,'山西',138,'阳泉',729,'平定',NULL),(10,35,'赵老师','','撒旦法萨芬',0,2,'',9,'http://www.baixing.cc/news/index.php?c=show&id=INSERT INTO `dr_1_news_index` (`uid`, `catid`, `status`, `inputtime`) VALUES (2, 35, 9, 1401784166)',0,NULL,0,0,0,'10','','男','校园','公司','四方达萨菲',15,'江西',254,'上饶',1685,'信州','小时');
...
insert  into `dr_member`(`uid`,`email`,`username`,`password`,`salt`,`name`,`phone`,`avatar`,`money`,`freeze`,`score`,`experience`,`adminid`,`groupid`,`levelid`,`overdue`,`regip`,`regtime`,`randcode`,`ismobile`,`loginlog`) values (1,'634842632@qq.com','admin','8901738ac8cfedbc3c4e8dc7f862da2e','f57a2f557b','','','','9999.00','0.00',10000,9810,1,3,4,0,'',0,0,0,''),(2,'63484263@qq.com','test','65ac5cf4300f2eae05b88d7815cb393a','03afdbd66e','','','','0.00','0.00',0,196,0,3,1,0,'127.0.0.1',1401503761,6738,0,'a:3:{i:0;a:3:{s:8:\\\"login_ip\\\";s:9:\\\"127.0.0.1\\\";s:10:\\\"login_time\\\";i:1401503843;s:10:\\\"login_type\\\";s:0:\\\"\\\";}i:-1;a:2:{s:10:\\\"login_time\\\";i:1401715108;s:10:\\\"login_type\\\";s:0:\\\"\\\";}i:2;a:3:{s:8:\\\"login_ip\\\";s:9:\\\"127.0.0.1\\\";s:10:\\\"login_time\\\";i:1401519407;s:10:\\\"login_type\\\";s:0:\\\"\\\";}}');
...
insert  into `dr_member_session`(`uid`,`time`,`session`) values (1,1401787145,'fdead5cb90a5a26a5c77f283c72524d7');
...
CREATE TABLE `provinces` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='Ê¡·ÝÐÅÏ¢±í';

/*Data for the table `provinces` */

insert  into `provinces`(`id`,`provinceid`,`province`) values (1,'110000','±±¾©ÊÐ'),(2,'120000','Ìì½òÊÐ'),(3,'130000','ºÓ±±Ê¡'),(4,'140000','É½Î÷Ê¡'),(5,'150000','ÄÚÃÉ¹Å×ÔÖÎÇø'),(6,'210000','ÁÉÄþÊ¡'),(7,'220000','¼ªÁÖÊ¡'),(8,'230000','ºÚÁú½­Ê¡'),(9,'310000','ÉÏº£ÊÐ'),(10,'320000','½­ËÕÊ¡'),(11,'330000','Õã½­Ê¡'),(12,'340000','°²»ÕÊ¡'),(13,'350000','¸£½¨Ê¡'),(14,'360000','½­Î÷Ê¡'),(15,'370000','É½¶«Ê¡'),(16,'410000','ºÓÄÏÊ¡'),(17,'420000','ºþ±±Ê¡'),(18,'430000','ºþÄÏÊ¡'),(19,'440000','¹ã¶«Ê¡'),(20,'450000','¹ãÎ÷×³×å×ÔÖÎÇø'),(21,'460000','º£ÄÏÊ¡'),(22,'500000','ÖØÇìÊÐ'),(23,'510000','ËÄ´¨Ê¡'),(24,'520000','¹óÖÝÊ¡'),(25,'530000','ÔÆÄÏÊ¡'),(26,'540000','Î÷²Ø×ÔÖÎÇø'),(27,'610000','ÉÂÎ÷Ê¡'),(28,'620000','¸ÊËàÊ¡'),(29,'630000','Çàº£Ê¡'),(30,'640000','ÄþÏÄ»Ø×å×ÔÖÎÇø'),(31,'650000','ÐÂ½®Î¬Îá¶û×ÔÖÎÇø'),(32,'710000','Ì¨ÍåÊ¡'),(33,'810000','Ïã¸ÛÌØ±ðÐÐÕþÇø'),(34,'820000','°ÄÃÅÌØ±ðÐÐÕþÇø');
