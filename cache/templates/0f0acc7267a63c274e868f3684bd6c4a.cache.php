...
<div class="condition_box" id="condition_box">
	<table class="condition_table">
	  ...
	  <tr><td class="td_left">价格:</td><td class="td_right">
	  		<div class="cat_cirle">
				<ul class="pager">
				  <li><a href="#">不限</a></li>
				</ul>
			...
			<div class="cat_words">
				<a>200元以下</a><a>200-600元</a><a>600-800元</a><a>800元以上</a><a>自定义区间:</a>
				 <input id="dr_jiage" class="input-text" type="text" required="required" style="width:100px;" value="" name="data[jiage]"></input>
				 <input id="dr_jiage" class="input-text" type="text" required="required" style="width:100px;" value="" name="data[jiage]"></input>
